...
class DataKernel():
    ...
    def processData(self, data_queue):
        ...
        if outArr is not None:
            # Ensure allcollectiondata is initialized correctly
            if len(self.allcollectiondata) == 0:
            ...
            try:
                ...
                self.trigno_base.csv_writer.push_to_lsl(np.array(outArr, dtype='float32').squeeze())  # Push data chunk to LSL
